...
#   
    ...
    $content =~ s/<p class="h1_章タイトル">(.*?)<\/p>/<div class="h1見出し">\n<h1>$1<\/h1>\n<\/div>/g;
    $content =~ s/<p class="h2_節タイトル">(.*?)<\/p>/<div class="h2見出し">\n<h2>$1<\/h2>\n<\/div>/g;
    $content =~ s/<p class="h3_項タイトル">(.*?)<\/p>/<div class="h3見出し">\n<h3>$1<\/h3>\n<\/div>/g;
...
# 目次テンプレートのコピーと名前変更
my $source_file = 'C:/Users/tomoki.kawakubo/050/03_setup/toolbox/template_mokuji_header.txt';
my $destination_file = 'C:/Users/tomoki.kawakubo/050/03_setup/arrange_toc.xhtml';

# 奥付テンプレートのコピーと名前変更
my $source_okuduke_file = 'C:/Users/tomoki.kawakubo/050/03_setup/toolbox/template_okuduke_header.txt';
my $destination_okuduke_file = 'C:/Users/tomoki.kawakubo/050/03_setup/arrange_colophone.xhtml';

copy($source_file, $destination_file) or die "ファイルのコピーに失敗しました: $!";
