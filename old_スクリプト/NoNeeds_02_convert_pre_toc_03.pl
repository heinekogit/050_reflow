...
# 素材テキストを読み込んで変換 ---------------------------------------------------------------------------------------
    ...
    my $input_file  = "02_getset/parts_mokuji.xhtml";     # sourceの目次ファイル抜粋部分
    my $output_file1 = "01_onmark/onmark_toc.xhtml";         # 出力ファイル
    my $output_file2 = "02_getset/getset_toc.xhtml"; # 出力ファイル
...
#    $content =~ s/source.html/target.xhtml/g;
